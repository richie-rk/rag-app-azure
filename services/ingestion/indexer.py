...
Handles:
  - Index creation with vector + semantic config (matching Max AI schema)
  - Document deduplication via SHA-256 hash (CRITICAL fix over Max AI)
  - Batch upload (batches of 1000)
  - Old document cleanup on re-ingestion
"""
...
def create_search_index(index_name: str) -> None:
    ...
    Replicates Max AI's index schema with additions:
      - document_hash field for dedup
      - Semantic configuration on content
      - Vector search profile for hybrid search
    """
