...
Tables:
  users: accounts (SSO and magic-link sign-in)
  projects: project and search-index configuration
  user_project_access: many-to-many users to projects, with a role
  ingestion_audit: per-document ingestion tracking
