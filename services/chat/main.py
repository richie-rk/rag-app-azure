"""FastAPI chat service for rag-app-azure.

Single endpoint: POST /chat — streams NDJSON responses.
Fixes over Max AI: JWT auth, configurable CORS, hybrid search, proper prompt.
"""
