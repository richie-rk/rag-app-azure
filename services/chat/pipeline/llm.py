"""Azure OpenAI chat completion with streaming.

Fixes over Max AI:
  - Uses singleton client instead of per-request instantiation
  - On BadRequestError: truncates history and retries (not a canned refusal)
  - No ChatML stop tokens (unnecessary with chat completions API)
"""
