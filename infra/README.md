...
| Resource | Free → Production | Monthly Cost |
|----------|------------------|-------------|
| SQL Database | Free → S0 (or GP Serverless) | $15–60 |
| AI Search | Free → Basic | $70 |
| App Service Plan | F1 → B1 (or P1v3) | $13–140 |
| Functions | Consumption → Premium EP1 | $150 |
| Storage | Standard_LRS → Standard_GRS | +$0.02/GB |
...
- **Idempotent**: Safe to run multiple times — checks if each resource exists before creating.
